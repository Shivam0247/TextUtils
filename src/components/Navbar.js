...
export default function Navbar(props) {
  return (
    <div>
         <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode==='dark'?'primary':'light'}`}>
...
{/* 
      ...
      <div className="bg-light rounded mx-2" onClick={()=>props.toggleMode("light")} style={{width:'30px', height:'30px'}}></div>
      <div className="bg-dark rounded mx-2" onClick={()=>props.toggleMode("dark")} style={{width:'30px', height:'30px'}}></div> */}
